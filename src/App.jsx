    ...
    <div>
      ...
      <div hidden={location.pathname == '/admin' && 'true' || location.pathname == '/admin-dashboard' && 'true'}>
        ...
        {/* +92-314-5167255 */}
          ...
          <a target="_blank" aria-label="Chat on WhatsApp" href="https://wa.me/923145167255?text=How%20can%20I%20book%20a%20guest%20house%3F"> <i style={{ color: '#0dc143' }} className="fa fa-whatsapp" aria-hidden="true"></i> </a>
        </div>
      </div>
      {/* <Navbar /> */}
      {appLoader && <div style={{
        ...
        <div className='d-flex flex-column justify-content-center align-items-center'>
          <img className='spinner-grow' src={"https://crosswindspk.com/static/media/LOGO.4a57ca52.png"} />
        </div>
      </div>
      }
